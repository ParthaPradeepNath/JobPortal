...
const JobPostingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Upexpected response:', response);
      ...
      if (error.response?.data?.message) {
        ...
        console.error('Upexpected error:', error);
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.salaryMin || !formData.salaryMax) {
      errors.salary = 'Both minimum and maximaum salary are required';
    ...
    const fetchJobDetails = async () => {
      if (jobId) {
        try {
          ...
          console.error('Error fetching jon details');
          if (error.response) {
            console.error('API Error:', error.response.data.message);
          }
        }
  ...
  return (
    <DashboardLayout activeMenu="post-job">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/300 to-purple-50/20 px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="focus:ring-opacity-20 w-full rounded-lg border-gray-300 py-2.5 pr-3 pl-10 text-base transition-colors duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                  </div>
                  <div className="relative">
                    <div className="pointer-events-none absolute inset-y-0 left-0 z-10 flex items-center pl-3">
                    ...
                    <input
                      ...
                      className="focus:ring-opacity-20 w-full rounded-lg border border-gray-300 py-2.5 pr-3 pl-10 text-base transition-colors duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                  </div>
                </div>
                {errors.salary && (
              ...
              <div className="pt-2">
                <button
                  ...
                  className="flex w-full items-center justify-center rounded-lg border border-transparent bg-blue-600 px-4 py-3 text-base font-medium text-white transition-colors duration-200 outline-none hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-400"
                >
                  {isSubmitting ? (
                    <>
