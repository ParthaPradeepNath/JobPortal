...
import ApplicantDashboardCard from '../../components/Cards/ApplicationDashboardCard';
    ...
    <Card className={`bg-gradient-to-br ${colorClasses[color]} border-0 text-white`}>
      <div className="flex items-center justify-between">
        <div>
          ...
          {trend && (
            <div className="items-centermt-2 flex text-sm">
  ...
  return (
    <DashboardLayout activeMenu="employer-dashboard">
      {isLoading ? (
        ...
        <div className="mx-auto mb-96 max-w-7xl space-y-8">
          {/* Dashboard Stats */}
          ...
          <Card title="Quick Actions" subtitle="Common tasks to get you started">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <button
                  key={index}
                  className="flex items-center space-x-3 rounded-xl border border-gray-100 p-4 text-left transition-all duration-200 hover:border-gray-200 hover:shadow-sm"
