                          ...
                          >
                            ...
                            <div className="flex items-center gap-3 mt-4 md:m-0">
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-2 px-3py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors"
                              >
                              ...
                              <button
                                ...
                                className=""
                              >
                                <Eye className="inline-flex items-center gap-2 px-3 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors" />
                                View Profile
                              </button>
                            </div>
                          </div>
