      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <ArrowLeft className="h-4 w-4 transition-transform group-hover:-tranlate-x-1" />
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-2 text-sm text-emerald-700 bg-emrald-100 px-3 py-1 rounded-full">
